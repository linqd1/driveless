...
#[cfg(test)]
mod tests {
	use crate::qtum::network::constants::Network as BtcNetwork;
	use crate::qtum::util::key::PublicKey as BtcPublicKey;
	use crate::qtum::{Address, Transaction as BtcTransaction, TxOut};
