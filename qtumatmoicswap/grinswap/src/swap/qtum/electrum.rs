...
use qtum::{Address, OutPoint, Script, Transaction};
use qtum_hashes::sha256d::Hash;
...
impl grinNodeClient for ElectrumNodeClient {
...
mod tests {
	...
	fn test_electrum() {
		...
		let addresses = vec![
			"grin-testnet.theblains.org:50007",
			"testnet.hsmiths.com:53011",
			"qtum-test.networkingfanatic.com:50003",
			"tn.not.fyi:55001",
		];
